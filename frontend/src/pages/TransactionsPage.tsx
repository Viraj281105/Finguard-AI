    ...
    <div className="min-h-screen bg-[#080a0e] text-white font-['DM_Sans',sans-serif]">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/[0.05] bg-[#080a0e]/80 backdrop-blur-xl px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          {/* Add Transaction button — Issue #8 will wire this up */}
          <button
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/[0.06]">
                  <th className="text-left px-6 py-4 text-xs text-white/30 uppercase tracking-widest font-medium">
                    Title
                  </th>
                  <th className="text-left px-6 py-4 text-xs text-white/30 uppercase tracking-widest font-medium">
                    Category
                  ...
                  <th className="text-right px-6 py-4 text-xs text-white/30 uppercase tracking-widest font-medium">
                    Amount
                  </th>
                  <th className="text-right px-6 py-4 text-xs text-white/30 uppercase tracking-widest font-medium">
                    Date
                ...
                {filtered.map((tx) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      ...
                      {tx.note && (
                        <p className="text-xs text-white/30 mt-0.5">{tx.note}</p>
                      )}
                    </td>
                    <td className="px-6 py-4">
